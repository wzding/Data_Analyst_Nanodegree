---
title: "Exploraroty Data Analysis A Case Study of Chicago Taxi Trips"
output:
  html_document
...
> **Introduction**: In this project, we will be analyzing City of Chicago taxi trip data to understand patterns in taxi ridership. The main taxi dataset is a publicly available government data which allows us to gain access to more than 200,000 taxi rides in Chicago from January 1 2017 to January 7 2017.
...
> **Trip duration**: Our first investigation is about the distribution of trip duration.
